...
################################################################################
## Form generated from reading UI file 'view_empleados.ui'
##
...
"border-radius: 0px;")
        ...
        self.clientes_table = QTableWidget(self.frame)
        self.clientes_table.setObjectName(u"clientes_table")
        self.clientes_table.setStyleSheet(u"background-color: rgb(235, 235, 235);")

        self.verticalLayout_8.addWidget(self.clientes_table)
    ...
    def retranslateUi(self, ViewEmpleado):
        ...
        self.label_tittle.setText(QCoreApplication.translate("ViewEmpleado", u"Empleados", None))
        ...
        self.new_request_button_cliente.setText(QCoreApplication.translate("ViewEmpleado", u"Nuevo Empleado", None))
        self.label.setText("")
        self.search_line_edit.setPlaceholderText(QCoreApplication.translate("ViewEmpleado", u"Buscar cliente...", None))
    # retranslateUi
