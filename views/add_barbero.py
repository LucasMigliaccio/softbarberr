...
################################################################################
## Form generated from reading UI file 'add_barbero.ui'
##
...
"")
        ...
        self.numero_lineEdit = QLineEdit(self.frame_inferior)
        self.numero_lineEdit.setObjectName(u"numero_lineEdit")
        self.numero_lineEdit.setMinimumSize(QSize(0, 30))
        self.numero_lineEdit.setStyleSheet(u"background-color: rgb(255, 255, 255);\n"
"border: 1px solid #cbcbcb\n"
"")

        self.verticalLayout_3.addWidget(self.numero_lineEdit)

        self.label = QLabel(self.frame_inferior)
        ...
        self.correo_lineEdit = QLineEdit(self.frame_inferior)
        self.correo_lineEdit.setObjectName(u"correo_lineEdit")
        self.correo_lineEdit.setMinimumSize(QSize(0, 30))
        self.correo_lineEdit.setStyleSheet(u"background-color: rgb(255, 255, 255);\n"
"border: 1px solid #cbcbcb")

        self.verticalLayout_3.addWidget(self.correo_lineEdit)
        ...
        self.direccion_lineEdit = QLineEdit(self.frame_inferior)
        self.direccion_lineEdit.setObjectName(u"direccion_lineEdit")
        self.direccion_lineEdit.setMinimumSize(QSize(0, 30))
        self.direccion_lineEdit.setStyleSheet(u"background-color: rgb(255, 255, 255);\n"
"border: 1px solid #cbcbcb\n"
"")

        self.verticalLayout_3.addWidget(self.direccion_lineEdit)

        self.pedido_tittle_9 = QLabel(self.frame_inferior)
        self.pedido_tittle_9.setObjectName(u"pedido_tittle_9")
        self.pedido_tittle_9.setFont(font2)
        self.pedido_tittle_9.setStyleSheet(u"color: rgb(230, 230, 230);")
        self.pedido_tittle_9.setAlignment(Qt.AlignCenter)

        self.verticalLayout_3.addWidget(self.pedido_tittle_9)

        self.especialidad_lineEdit = QLineEdit(self.frame_inferior)
        self.especialidad_lineEdit.setObjectName(u"especialidad_lineEdit")
        self.especialidad_lineEdit.setMinimumSize(QSize(0, 30))
        self.especialidad_lineEdit.setStyleSheet(u"background-color: rgb(255, 255, 255);\n"
"border: 1px solid #cbcbcb\n"
"")

        self.verticalLayout_3.addWidget(self.especialidad_lineEdit)
...
"")
    ...
    def retranslateUi(self, add_edit_cliente):
        ...
        self.label_tittle.setText(QCoreApplication.translate("add_edit_cliente", u"Nuevo Barbero", None))
        ...
        self.pedido_tittle_5.setText(QCoreApplication.translate("add_edit_cliente", u"N\u00daMERO", None))
        self.label.setText(QCoreApplication.translate("add_edit_cliente", u"CORREO ELECTR\u00d3NICO", None))
        self.correo_lineEdit.setPlaceholderText(QCoreApplication.translate("add_edit_cliente", u"example@gmail.com", None))
        self.pedido_tittle_8.setText(QCoreApplication.translate("add_edit_cliente", u"DIRECCI\u00d3N/ES", None))
        self.pedido_tittle_9.setText(QCoreApplication.translate("add_edit_cliente", u"ESPECIALIDAD", None))
