...
################################################################################
## Form generated from reading UI file 'add_producto_in_cita.ui'
##
...
"border-radius: 0px;\n"
"image: url(:/newPrefix/search.png);")
        self.label.setPixmap(QPixmap(u"L:/AngelCuk/assets/icons/search.png"))
...
"border-radius: 0px;")
    ...
    def retranslateUi(self, ViewEmpleado):
        ...
        self.label_tittle.setText(QCoreApplication.translate("ViewEmpleado", u"Agregar Productos a la Cita", None))
        ...
        self.label.setText("")
        self.search_line_edit.setPlaceholderText(QCoreApplication.translate("ViewEmpleado", u"Buscar producto...", None))
    # retranslateUi
