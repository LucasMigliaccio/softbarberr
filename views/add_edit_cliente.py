...
################################################################################
## Form generated from reading UI file 'add_edit_cliente.ui'
##
...
"")
        ...
        self.fechacum_lineEdit = QLineEdit(self.frame_inferior)
        self.fechacum_lineEdit.setObjectName(u"fechacum_lineEdit")
        self.fechacum_lineEdit.setMinimumSize(QSize(0, 30))
        self.fechacum_lineEdit.setStyleSheet(u"background-color: rgb(255, 255, 255);\n"
"border: 1px solid #cbcbcb")

        self.verticalLayout_3.addWidget(self.fechacum_lineEdit)
...
"")
    ...
    def retranslateUi(self, add_edit_cliente):
        ...
        self.label_tittle.setText(QCoreApplication.translate("add_edit_cliente", u"Nuevo Cliente", None))
        ...
        self.fechacum_lineEdit.setPlaceholderText(QCoreApplication.translate("add_edit_cliente", u"example@gmail.com", None))
