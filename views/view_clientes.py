...
################################################################################
## Form generated from reading UI file 'view_clientes.ui'
##
...
"border-radius: 0px;")
    ...
    def retranslateUi(self, ViewCliente):
        ...
        self.label_tittle.setText(QCoreApplication.translate("ViewCliente", u"Clientes", None))
        ...
        self.new_request_button_cliente.setText(QCoreApplication.translate("ViewCliente", u"Nuevo Cliente", None))
        self.label.setText("")
        self.search_line_edit.setPlaceholderText(QCoreApplication.translate("ViewCliente", u"Buscar cliente...", None))
    # retranslateUi
