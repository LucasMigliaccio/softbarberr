...
################################################################################
## Form generated from reading UI file 'add_producto_automatizado.ui'
##
...
"}")
        ...
        self.monto_tittle_2 = QLabel(self.frame_5)
        self.monto_tittle_2.setObjectName(u"monto_tittle_2")
        self.monto_tittle_2.setMaximumSize(QSize(235, 16777215))
        self.monto_tittle_2.setFont(font1)
        self.monto_tittle_2.setStyleSheet(u"color: rgb(230, 230, 230);")
        self.monto_tittle_2.setAlignment(Qt.AlignCenter)

        self.horizontalLayout_9.addWidget(self.monto_tittle_2)
...
"")
    ...
    def retranslateUi(self, add_edit_menu):
        ...
        self.monto_tittle_2.setText(QCoreApplication.translate("add_edit_menu", u"DESCUENTO (%)", None))
