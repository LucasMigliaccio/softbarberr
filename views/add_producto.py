...
"")
        ...
        self.codigo_tittle_2 = QLabel(self.frame_inferior)
        self.codigo_tittle_2.setObjectName(u"codigo_tittle_2")
        self.codigo_tittle_2.setFont(font2)
        self.codigo_tittle_2.setStyleSheet(u"color: rgb(230, 230, 230);")
        self.codigo_tittle_2.setAlignment(Qt.AlignCenter)

        self.verticalLayout_3.addWidget(self.codigo_tittle_2)

        self.categoria_comboBox = QComboBox(self.frame_inferior)
        self.categoria_comboBox.setObjectName(u"categoria_comboBox")
        self.categoria_comboBox.setMinimumSize(QSize(0, 30))
        self.categoria_comboBox.setStyleSheet(u"background-color: rgb(255, 255, 255);\n"
"border: 1px solid #cbcbcb")

        self.verticalLayout_3.addWidget(self.categoria_comboBox)
...
"")
    ...
    def retranslateUi(self, add_edit_cliente):
        ...
        self.codigo_lineEdit.setPlaceholderText(QCoreApplication.translate("add_edit_cliente", u"Primera s\u00edlaba de la empresa + n\u00famero \u00fanico del producto. Ejemplo: LEVI'S, LE0001.", None))
        self.codigo_tittle_2.setText(QCoreApplication.translate("add_edit_cliente", u"CATEGORIA", None))
