...
################################################################################
## Form generated from reading UI file 'add_edit_cita.ui'
##
...
"color: rgb(189, 189, 189);")
        ...
        self.fechayhora_lineEdit = QLineEdit(self.frame_inferior)
        self.fechayhora_lineEdit.setObjectName(u"fechayhora_lineEdit")
        self.fechayhora_lineEdit.setMinimumSize(QSize(0, 40))
        self.fechayhora_lineEdit.setStyleSheet(u"background-color: rgb(255, 255, 255);\n"
"border: 1px solid #cbcbcb;")

        self.verticalLayout_3.addWidget(self.fechayhora_lineEdit)
        ...
        self.barbero_lineEdit = QLineEdit(self.frame_inferior)
        self.barbero_lineEdit.setObjectName(u"barbero_lineEdit")
        self.barbero_lineEdit.setMinimumSize(QSize(0, 40))
        self.barbero_lineEdit.setStyleSheet(u"background-color: rgb(255, 255, 255);\n"
"border: 1px solid #cbcbcb;")

        self.verticalLayout_3.addWidget(self.barbero_lineEdit)
        ...
        self.cliente_tittle.setFont(font2)
        ...
        self.cliente_lineEdit = QLineEdit(self.frame_inferior)
        self.cliente_lineEdit.setObjectName(u"cliente_lineEdit")
        self.cliente_lineEdit.setMinimumSize(QSize(400, 40))
        self.cliente_lineEdit.setMaximumSize(QSize(16777215, 16777215))
        self.cliente_lineEdit.setStyleSheet(u"background-color: white;\n"
"border: 1px solid grey;")

        self.verticalLayout_3.addWidget(self.cliente_lineEdit)
...
"border: 1px solid grey;")
        ...
        self.horizontalLayout.addWidget(self.imagen_lineEdit)
