...
################################################################################
## Form generated from reading UI file 'detail_cliente.ui'
##
...
"")
    ...
    def retranslateUi(self, add_edit_menu):
        ...
        self.label_tittle.setText(QCoreApplication.translate("add_edit_menu", u"Cliente Detalle", None))
        ...
        self.pedido_tittle_10.setText(QCoreApplication.translate("add_edit_menu", u"ID CLIENTE", None))
